...
//                ")\n");
        ...
        // TODO oracle提单状态表 加主键、UUID、BIZ_STATUS_IFFECTIVE
        tEnv.executeSql("" +
...
//        Table table = tEnv.sqlQuery("select * from ORACLE_TRACK_BIZ_STATUS_BILL");
...
//        env.execute();
        ...
        tEnv.executeSql("" +
                ...
                "    'password' = 'easipass'\n" +
                ")\n");
//        Table ORACLE_TRACK_BIZ_STATUS_CTNR_table = tEnv.sqlQuery("select * from ORACLE_TRACK_BIZ_STATUS_CTNR");
//        tEnv.toAppendStream(ORACLE_TRACK_BIZ_STATUS_CTNR_table, Row.class).print();
//        env.execute();
...
//        Table ORACLE_CTNR_DIM_table = tEnv.sqlQuery("select * from ORACLE_CTNR_DIM");
//        tEnv.toAppendStream(ORACLE_CTNR_DIM_table, Row.class).print();
//        env.execute();
...
//        env.execute();
        ...
        tEnv.executeSql("" +
                ...
                "  `map`['VOYAGE'],\n" +
                "  `map`['BLNO'],\n" +
//                "  UPPER(TRIM(REGEXP_REPLACE(`map`['BLNO'], '[\\t\\n\\r]', ''))),\n" +
                "  `map`['TRADENAME'],\n" +
                "  `map`['OWNERNAME'],\n" +
                "  `map`['AGENTNAME'],\n" +
                "  `map`['DISCHARGE_PLACE'],\n" +

...
//		env.execute();
        ...
        tEnv.executeSql("" +
                ...
                "select\n" +
                "  msgId,GID,\n" +
                "  VSL_NAME,VOYAGE,ACCURATE_VSLNAME,\n" +
...
//        env.execute();
        ...
        tEnv.executeSql("" +
                ...
                "select\n" +
                "    ctnrTB_tmp.*,\n" +
                "    if(obcd.VSL_IMO_NO <> 'N/A',obcd.VSL_IMO_NO,'N/A') as VSL_IMO_NO,\n" +
                "    if(obcd.VSL_IMO_NO <> 'N/A',obcd.VSL_IMO_NO,'N/A') as ACCURATE_IMONO\n" +
                "from ctnrTB_tmp left join oracle_blctnr_dim FOR SYSTEM_TIME AS OF ctnrTB_tmp.LASTUPDATEDDT as obcd  --拿分提单号\n" +
                "                            on ctnrTB_tmp.VSL_NAME=obcd.VSL_NAME\n" +
                "                                and ctnrTB_tmp.VOYAGE=obcd.VOYAGE\n" +
                "                                and ctnrTB_tmp.I_E_MARK=obcd.I_E_MARK\n" +
...
//        Table billFromCtnr_tmp = tEnv.sqlQuery("select * from billFromCtnr_tmp");
//        tEnv.toAppendStream(billFromCtnr_tmp, Row.class).print();
//		env.execute();

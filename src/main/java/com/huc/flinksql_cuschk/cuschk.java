...
//        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        ...
        tEnv.executeSql("" +
                ...
                "  'properties.bootstrap.servers' = '192.168.129.151:9092,192.168.129.152:9092,192.168.129.153:9092',\n" +
...
//        tEnv.executeSql("select * from BILL_INFO").print();
...
//        tEnv.executeSql("select * from TMP_CTNR_INFO").print();
...
//        tEnv.executeSql("select * from CTNR_INFO").print();
...
//        tEnv.executeSql("select * from BILL").print();

        StatementSet statementSet = tEnv.createStatementSet();

        // TODO 写入到oracle的提单状态表
...
//                "FROM BILL\n");
        ...
        statementSet.addInsertSql("" +
                ...
                "    BIZ_STAGE_CODE, BIZ_STAGE_NAME, BIZ_TIME, BIZ_STATUS_CODE, BIZ_STATUS, BIZ_STATUS_DESC, LASTUPDATEDDT, ISDELETED) AS DATA\n" +
                "FROM (\n" +
                "  SELECT\n" +
                "    b.GID AS GID,\n" +
...
//        tEnv.executeSql("select * from CTNR").print();
...
//                "FROM CTNR\n");
        ...
        statementSet.addInsertSql("" +
                ...
                "    BIZ_STAGE_NAME, BIZ_TIME, BIZ_STATUS_CODE, BIZ_STATUS, BIZ_STATUS_DESC, LASTUPDATEDDT, ISDELETED) AS DATA -- 此时的 LASTUPDATEDDT 没有  '.'\n" +
                "FROM (\n" +
                "  SELECT\n" +
                "    c.GID AS GID,\n" +
                "    p.APP_NAME AS APP_NAME,\n" +
